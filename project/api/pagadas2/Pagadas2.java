...
public class Pagadas2 {
    public void execute(HttpExchange exchange) throws IOException {
        try {
            ...
            /*String sql = SqlFileLoader.loadFile("ORDENES_PAGADAS.sql", desde, hasta);
            ...
            ThreadConsult task = new ThreadConsult(desde, hasta,"ORDENES_PAGADAS.sql", result -> {
                try {
                    ResponseUtils.respuestaJSON(exchange, 200, result);
