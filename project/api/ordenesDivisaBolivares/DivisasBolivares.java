package project.api.ordenesDivisaBolivares;
...
public class DivisasBolivares {
    public void execute(HttpExchange exchange) throws IOException {
        try {
            ...
            ThreadConsult task = new ThreadConsult(desde, hasta,"Dolares_a_Bolivares.sql", result -> {
                try {
                    ResponseUtils.respuestaJSON(exchange, 200, result);
